    ...
    def draw_board(self, board, arena_size):
        ...
        if pygame.font:
            ...
            for row in range(arena_size):
                ...
                self.screen.blit(text, (arena_size * self.box_size + 10, row * self.box_size + self.box_size / 4))
            for col in range(arena_size):
                text = font.render(chr(ord('A') + col), 1, black)
                self.screen.blit(text, (col * self.box_size + self.box_size / 4, arena_size * self.box_size + 10))
